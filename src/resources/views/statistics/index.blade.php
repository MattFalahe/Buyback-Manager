    ...
    <div class="buyback-manager-wrapper">
            ...
            <div class="col-md-12">
                <div class="card card-dark">
                    <div class="card-header">
                        <h3 class="card-title">Daily Buyback Activity</h3>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card card-dark">
                    <div class="card-header">
                        <h3 class="card-title">Average Contract Value</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card card-dark">
                    <div class="card-header">
                        <h3 class="card-title">Average Items Per Contract</h3>
                    </div>
                    <div class="card-body">
                        <div style="text-align: center; padding: 20px;">
...
@push('javascript')
    <script src="{{ asset('vendor/buyback-manager/js/chart.min.js') }}"></script>
    <script>
    ...
    <script src="{{ asset('vendor/buyback-manager/js/statistics.js') }}"></script>
@endpush
